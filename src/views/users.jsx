...
function Users({history}) {
    ...
    const baseUrl = 'http://ec2-54-208-27-215.compute-1.amazonaws.com:3000/api/users';
    ...
    const deleteUser = async (id) => {
        if(localStorage.UserId != id){
            ...
            await axios.delete('http://ec2-54-208-27-215.compute-1.amazonaws.com000/api/users/' + id)
            console.log(id)
            fetcData();
        }
    }
